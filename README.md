...
Since Bigquery does not provide any feature for informing about the updates or deletes, it is not possible to track updations. And hence, currently updataion/deletion is not handled by the connector. 
